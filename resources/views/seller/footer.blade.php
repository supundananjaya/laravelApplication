  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body login-popup">
		<div class="left">
			<img src="{{asset('img/logo-high.png')}}" width="400" height="auto">
		</div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body forgot-popup">
		...
		<div class="right">
			<img src="{{asset('img/forgot-password-img.png')}}" width="100%" height="auto">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-3 col-xs-12">
							<div class="footer">
									<a href="#" class="logo">
											<img src="{{asset('./img/logo-white.png')}}" width="120" alt="logo">
										</a>
